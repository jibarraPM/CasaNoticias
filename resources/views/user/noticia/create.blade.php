                ...
                <div class="intro-y box p-5">
                    ...
                    <div class="mt-3">
                        ...
                        <select data-placeholder="Select your favorite actors" class="tom-select w-full" id="categorias" name="categorias" multiple>
                            <option value="Políticas" selected>Políticas</option>
                            <option value="Deportivas">Deportivas</option>
                            <option value="Económicas" selected>Económicas</option>
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mt-2">
                            <div class="editor">
                                <input id="cuerpo" name="cuerpo" type="text" class="form-control" cols="30" rows="10" placeholder="Ingrese el cuerpo de la noticia." >
                            </div>
                        </div>
                    </div>
                    <div class="mt-3">
                        ...
                        <div class="input-group">
                            <input id="cierre" name="cierre" type="text" class="form-control" placeholder="Ingrese ideas secundarias o información suplementaria." aria-describedby="input-group-2">
                        </div>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="text-right mt-5">
                        ...
                        <button type="submit" class="btn btn-primary w-24">Agregar</button>
                    </div>
                </div>
            </form>
            <!-- END: Form Layout -->
